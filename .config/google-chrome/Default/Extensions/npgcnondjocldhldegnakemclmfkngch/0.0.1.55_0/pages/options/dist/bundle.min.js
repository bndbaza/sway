...
var csjs = __webpack_require__(36);

module.exports = csjs;
module.exports.csjs = csjs;
module.exports.getCss = __webpack_require__(37);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getInfoLi;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_csjs_inject__);




var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getInfoLi() {

  const scopedCss = __WEBPACK_IMPORTED_MODULE_2_csjs_inject___default.a`
  ...
  const InfoIcon = function InfoIcon(props) {
    ...
    return createVNode(128, 'svg', 'icon', ['$', createVNode(2, 'use', null, null, {
      'xlink:href': '#iconInfo'
    }), '$'], {
      'style': 'position: relative; top: 0.08em'
    });
  };
  ...
  return function InfoLi(originalProps) {
    ...
    return createVNode(2, 'li', scopedCss.infoRow + ' horFlex', [__WEBPACK_IMPORTED_MODULE_1_inferno_create_element___default()('input', inputProps), createVNode(2, 'div', scopedCss.labelContainer, [createVNode(2, 'label', null, null, {
      'for': iddy,
      'dangerouslySetInnerHTML': { __html: props.conf.label }
    }), props.nodeAfterLabel]), props.conf.desc ? createVNode(2, 'div', scopedCss.desc, [createVNode(16, InfoIcon), createVNode(2, 'div', scopedCss.tooltip, null, {
      'dangerouslySetInnerHTML': { __html: props.conf.desc }
    })]) : props.conf.url ? createVNode(2, 'a', [scopedCss.rightBottomIcon, scopedCss.infoUrl].join(' '), createVNode(16, InfoIcon), {
      'href': props.conf.url,
      'title': '\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u0430\u0446\u0438\u044E'
    }) : createVNode(2, 'span', null, '\xA0') // Affects vertical align of flexbox items.
    , props.checked && props.children && createVNode(2, 'div', scopedCss.children, props.children)], {
      'style': props.children && 'flex-wrap: wrap'
    });
  };
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__NotControlledWarning__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Main__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Footer__ = __webpack_require__(26);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getApp(theState) {

  const NotControlledWarning = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__NotControlledWarning__["a" /* default */])(theState);
  const Main = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__Main__["a" /* default */])(theState);
  const Footer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__Footer__["a" /* default */])(theState);

  return class App extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    setNewsStatusTo(newsArr) {
      ...
      this.setStatusTo(createVNode(2, 'ol', null, newsArr.map(([title, url]) => createVNode(2, 'li', null, createVNode(2, 'a', null, title, {
        'href': url
      }))).reverse() // News order.
      , {
    ...
    async showNews() {
      ...
      const [error, comments, etag] = await fetch(ghUrl, params).then(res => !(res.status >= 200 && res.status < 300 || res.status === 304) ? Promise.reject({ message: `Получен ответ с неудачным кодом ${res.status}.`, data: res }) : res).then(res => Promise.all([null, res.status !== 304 ? res.json() : false, res.headers.get('ETag')]), err => {

        const statusCode = err.data && err.data.status;
        const ifCritical = null;
        this.showErrors(ifCritical, {
          message: statusCode === 403 ? 'Слишком много запросов :-( Сообщите разработчику, как вам удалось всё истратить.' : 'Не удалось достать новости: что-то не так с сетью.',
          wrapped: err
        });
    ...
    showErrors(err, ...args /* ...warns, cb */) {
      ...
      const cb = lastArg && typeof lastArg === 'function' ? args.pop() : () => {};
      const warns = args;
      ...
      const warningHtml = warns.filter(w => w).map(w => errToHtmlMessage(w)).map(m => '✘ ' + m).join('<br/>');

      messageHtml = messageHtml.trim();
      if (warningHtml) {
        messageHtml = messageHtml ? messageHtml + '<br/>' + warningHtml : warningHtml;
      }
      this.setStatusTo(createVNode(2, 'span', null, [createVNode(2, 'span', null, err ? createVNode(2, 'span', null, [createVNode(2, 'span', 'emoji', '\uD83D\uDD25'), ' ', chrome.i18n.getMessage('Error'), '!']) : `${chrome.i18n.getMessage('Non_critical_error')}.`, {
        'style': 'color:red'
      }), createVNode(2, 'br'), createVNode(2, 'span', null, null, {
        'style': 'font-size: 0.9em; color: darkred',
        'dangerouslySetInnerHTML': { __html: messageHtml }
      }), ' ', err && createVNode(2, 'a', null, '[\u0422\u0435\u0445\u043D.\u0434\u0435\u0442\u0430\u043B\u0438]', {
        'href': '',
        'onClick': evt => {
    ...
    conduct(beforeStatus, operation, afterStatus, onSuccess = () => {}, onError = () => {}) {
    ...
    render(originalProps) {
      ...
      return __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()('div', null, [...(props.flags.ifNotControlled ? [__WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(NotControlledWarning, props)] : []), __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(Main, props), __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(Footer, Object.assign({ status: this.state.status }, props))]);
    }
...
function append(document, { flags }) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getApplyMods;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);


var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getApplyMods(theState) {
  ...
  const resetMods = function resetMods(props) {
    ...
    props.funs.conduct('Сбрасываем...', cb => {

      props.apis.pacKitchen.resetToDefaults();
      props.bgWindow.utils.fireRequest('ip-to-host-reset-to-defaults', cb);
      window.localStorage.clear();
    }, 'Откройте окно заново для отображения эффекта.', () => window.close());
  };

  return function ApplyMods(props) {

    return createVNode(2, 'section', 'controlRow horFlex', [createVNode(512, 'input', null, null, {
      'type': 'button',
      'value': '\u041F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C',
      'disabled': props.ifInputsDisabled,
      'onClick': props.onClick
    }), createVNode(2, 'a', null, '\u041A \u0438\u0437\u043D\u0430\u0447\u0430\u043B\u044C\u043D\u044B\u043C!', {
      'href': '',
      'onClick': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(props, resetMods)
    })], {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getExcEditor;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_component__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getExcEditor(theState) {
  ...
  */
  ...
  return class ExcEditor extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {

    modsToOpts(pacMods) {

      return Object.keys(pacMods.exceptions || {}).sort().map(excHost => [excHost, pacMods.exceptions[excHost]]);
    }

    constructor(props) {

      super(props);
      const trimmedInputValueOrSpace = props.currentTab && props.currentTab.url && !props.currentTab.url.startsWith('chrome') ? '*.' + new URL(props.currentTab.url).hostname.replace(/^www\./g, '') : '';
    ...
    hideAllOptions() {
      ...
      this.setState({
        hostToIfHidden: this.state.sortedListOfOptions.reduce((hostToIfHidden, [excHost]) => {
    ...
    handleRadioClick(event) {
      ...
      (() => {
        ...
        switch (event.target.id) {
          ...
          case 'this-no':
            if (ifYesClicked && !pacMods.filteredCustomsString) {
              this.props.funs.showErrors(new TypeError(chrome.i18n.getMessage('noOwnProxiesError')));
              return false;
            }
        ...
        this.props.funs.conduct('Применяем исключения...', cb => this.props.apis.pacKitchen.keepCookedNowAsync(pacMods, cb), 'Исключения применены. Не забывайте о кэше!', () => this.setState({ sortedListOfOptions: this.modsToOpts(pacMods) }));
      })();
    ...
    handleInputOrClick(event) {
      ...
      let ifTriangleClicked = false;
      {
        ...
        ifTriangleClicked = ifClick && !this.rawInput.selectionStart && !this.rawInput.selectionEnd && event.x > this.rawInput.getBoundingClientRect().right - maxIndentFromRightInPx;
      }
      ...
      const hidden = this.state.sortedListOfOptions.reduce((hiddenAcc, [excHost, excState]) => {
    ...
    render(props) {
      ...
      return createVNode(2, 'section', null, [createVNode(2, 'div', null, chrome.i18n.getMessage('ProxyTheDomainNameBelowQ')), createVNode(2, 'div', null, [createVNode(2, 'div', inputProxyingState !== undefined ? inputProxyingState === true ? scopedCss.ifYes : scopedCss.ifNo : '', createVNode(512, 'input', null, null, {
        'placeholder': '*.navalny.com',
        'list': 'exc-list',
        'id': 'exc-editor',
        ...
        this.rawInput = inputNode;
      }), {
        'id': 'exc-address'
      }), createVNode(2, 'a', null, createVNode(128, 'svg', 'icon', createVNode(2, 'use', null, null, {
        'xlink:href': '#iconImportExport'
      })), {
        'href': '../exceptions/index.html',
        'title': '\u0438\u043C\u043F\u043E\u0440\u0442/\u044D\u043A\u0441\u043F\u043E\u0440\u0442'
      })], {
        'id': 'exc-address-container'
      }), createVNode(2, 'datalist', null, this.state.sortedListOfOptions.map(([excHost, excState]) => {
        ...
        return createVNode(2, 'option', null, null, {
          'value': this.state.hostToIfHidden[excHost] ? '\n' : excHost + ' ',
          'label': ifProxy === true ? labelIfProxied : ifProxy === false ? labelIfNotProxied : labelIfAuto
        });
      }), {
        'id': 'exc-list'
      }), createVNode(2, 'ol', 'horizontalList middledChildren', [createVNode(2, 'li', null, [createVNode(512, 'input', null, null, {
        'id': 'this-auto',
        'type': 'radio',
        'checked': true,
        'name': 'if-proxy-this-site',
        'onClick': this.handleRadioClick
      }), ' ', createVNode(2, 'label', null, [createVNode(128, 'svg', 'icon', createVNode(2, 'use', null, null, {
        'xlink:href': '#iconLoopRound'
      }), {
        'style': 'position: relative; top: 0.15em;'
      }), '\xA0', chrome.i18n.getMessage('auto')], {
        'for': 'this-auto'
      })]), createVNode(2, 'li', null, [createVNode(512, 'input', null, null, {
        'id': 'this-yes',
        'type': 'radio',
        'name': 'if-proxy-this-site',
        'checked': inputProxyingState === true,
        'onClick': this.handleRadioClick
      }), ' ', createVNode(2, 'label', null, [createVNode(2, 'span', 'emoji____buggy', '\u2714'), '\xA0', chrome.i18n.getMessage('yes')], {
        'for': 'this-yes'
      })]), createVNode(2, 'li', null, [createVNode(512, 'input', null, null, {
        'id': 'this-no',
        'type': 'radio',
        'name': 'if-proxy-this-site',
        'checked': inputProxyingState === false,
        'onClick': this.handleRadioClick
      }), ' ', createVNode(2, 'label', null, [createVNode(2, 'span', 'emoji', '\u2718'), '\xA0', chrome.i18n.getMessage('no')], {
        'for': 'this-no'
      })])], {
        'id': 'exc-radio'
      })], {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getExceptions;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_create_element__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_create_element___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_create_element__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_csjs_inject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__InfoLi__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ExcEditor__ = __webpack_require__(24);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getExceptions(theState) {
  ...
  const InfoLi = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__InfoLi__["a" /* default */])(theState);
  const ExcEditor = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__ExcEditor__["a" /* default */])(theState);

  return function Exceptions(props) {

    const applyMods = newMods => {

      props.apis.pacKitchen.keepCookedNowAsync(newMods, (err, ...warns) => err ? props.funs.showErrors(err, ...warns) : props.funs.setStatusTo('Применено.'));
    };

    return props.flags.ifInsideOptionsPage ? createVNode(2, 'div', 'nowrap', ['\u0420\u0435\u0434\u0430\u043A\u0442\u043E\u0440 \u0438\u0441\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0439 \u0434\u043E\u0441\u0442\u0443\u043F\u0435\u043D \u0442\u043E\u043B\u044C\u043A\u043E \u0434\u043B\u044F ', createVNode(2, 'a', null, '\u0432\u043A\u043B\u0430\u0434\u043E\u043A', {
      'href': 'chrome://newtab'
    }), '.']) : createVNode(2, 'div', null, [__WEBPACK_IMPORTED_MODULE_1_inferno_create_element___default()(ExcEditor, props), createVNode(2, 'ul', scopedCss.excMods, [props.apis.pacKitchen.getOrderedConfigs('exceptions').map(conf => {

      return createVNode(16, InfoLi, null, null, {
        'type': 'checkbox',
        'conf': conf,
        'idPrefix': 'mods-',
        'checked': conf.value,
    ...
    }), !props.flags.ifMini && createVNode(16, InfoLi, null, null, {
      'type': 'checkbox',
      'conf': {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getFooter;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_csjs_inject__);



var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getFooter(theState) {

  const scopedCss = __WEBPACK_IMPORTED_MODULE_1_csjs_inject___default.a`
  ...
  return props => createVNode(2, 'div', 'horPadded', [createVNode(2, 'section', scopedCss.statusRow, createVNode(2, 'div', scopedCss.status, typeof props.status === 'string' ? createVNode(2, 'div', null, null, {
    'dangerouslySetInnerHTML': { __html: props.status }
  }) : props.status, {
    'style': 'will-change: contents'
  })), createVNode(2, 'footer', scopedCss.controlRow + ' horFlex nowrap', [createVNode(512, 'input', null, null, {
    'type': 'button',
    'value': chrome.i18n.getMessage('Finish'),
    'disabled': props.ifInputsDisabled,
    'style': { display: theState.flags.ifInsideEdgeOptionsPage ? 'none' : 'initial' },
    'onClick': () => window.close()
  }), createVNode(2, 'a', null, chrome.i18n.getMessage('Donate'), {
    'href': 'https://rebrand.ly/ac-donate'
  }), createVNode(2, 'a', null, chrome.i18n.getMessage('ProblemsQ'), {
    'data-in-bg': 'false',
    'href': '../troubleshoot/index.html'
  })])]);
};
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getLastUpdateDate;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_component__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getLastUpdateDate(theState) {

  return class LastUpdateDate extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    getDate(antiCensorRu) {
      ...
      if (antiCensorRu.lastPacUpdateStamp) {
        ...
        const gauges = [[1000, chrome.i18n.getMessage('s')], [60, chrome.i18n.getMessage('min')], [60, chrome.i18n.getMessage('h')], [24, chrome.i18n.getMessage('d')], [7, chrome.i18n.getMessage('w')], [4, chrome.i18n.getMessage('m')]];
    ...
    render(props) {
      ...
      return createVNode(2, 'div', null, [chrome.i18n.getMessage('Updated'), ': ', createVNode(2, 'span', 'updateDate', date.text, {
        'title': date.title
      })]);
    }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getMain;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inferno_create_element__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_inferno_create_element__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_csjs_inject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__TabPanel__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PacChooser__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Exceptions__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ModList__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ProxyEditor__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ApplyMods__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Notifications__ = __webpack_require__(31);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getMain(theState) {

  const scopedCss = __WEBPACK_IMPORTED_MODULE_3_csjs_inject___default.a`
  ...
  const TabPanel = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__TabPanel__["a" /* default */])(theState);

  const PacChooser = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__PacChooser__["a" /* default */])(theState);
  const Exceptions = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__Exceptions__["a" /* default */])(theState);
  const ModList = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__ModList__["a" /* default */])(theState);
  const ProxyEditor = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__ProxyEditor__["a" /* default */])(theState);
  const ApplyMods = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__ApplyMods__["a" /* default */])(theState);
  const Notifications = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__Notifications__["a" /* default */])(theState);

  const checksName = 'pacMods';
  let selection = [0, 0]; // TODO: dirty hack but seems ok.

  return class Main extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    getAllMods() {
      ...
      return [].concat(...Object.keys(this.state.catToOrderedMods).map(cat => this.state.catToOrderedMods[cat]));
    }
    ...
    handleModApply(that) {
      ...
      that.props.funs.conduct('Применяем настройки...', cb => that.props.apis.pacKitchen.keepCookedNowAsync(newMods, cb), 'Настройки применены.', () => that.setState({
        ifModsChangesAreStashed: false,
        ifModsChangesAreValid: true
      }));
    }
    ...
    render(props) {
      ...
      const applyModsEl = __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(ApplyMods, Object.assign({}, props, {
        ifInputsDisabled: !this.state.ifModsChangesAreStashed || props.ifInputsDisabled,
        onClick: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleModApply)
      }));
      ...
      return __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(TabPanel, Object.assign({}, props, {
        tabs: [{
          label: chrome.i18n.getMessage('PAC_script'),
          content: __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(PacChooser, props),
          key: 'pacScript'
        }, {
          label: chrome.i18n.getMessage('Exceptions'),
          content: __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(Exceptions, props),
          key: 'exceptions'
        }, {
          label: chrome.i18n.getMessage('Own_proxies'),
          content: __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(ModList, Object.assign({}, props, {
            orderedConfigs: this.state.catToOrderedMods['ownProxies'],
            childrenOfMod: {
              customProxyStringRaw: ProxyEditor,
              replaceDirectWith: ({ conf, onNewValue, ifInputsDisabled }) => createVNode(512, 'input', null, null, {
          ...
          content: __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(Notifications, props),
          key: 'notifications'
        }],
        alwaysShownWith: {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getModList;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_component__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getModList(theState) {

  const InfoLi = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__InfoLi__["a" /* default */])(theState);

  return class ModList extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    handleCheck(confMeta, ifChecked) {
      ...
      this.setState({
        checks: this.state.checks.map((ch, i) => i === confMeta.index ? ifChecked : ch)
      });
    ...
    render(props) {
      ...
      return createVNode(2, 'ol', null, props.orderedConfigs.map((conf, index) => {

        const ifMayHaveChild = props.childrenOfMod && props.childrenOfMod[conf.key];
        const confMeta = { conf, index, ifChild: ifMayHaveChild };

        const child = ifMayHaveChild && this.state.checks[index] && __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(props.childrenOfMod[conf.key], Object.assign({}, props, {
          conf,
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getNotControlledWarning;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_csjs_inject__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_1_inferno___default.a.createVNode;
function getNotControlledWarning({ flags }) {

  const cssClasses = __WEBPACK_IMPORTED_MODULE_0_csjs_inject___default.a`
  ...
  return function NotControlledWarning(props) {
    ...
    return createVNode(2, 'section', cssClasses.warningContainer + " horPadded", null, {
      'dangerouslySetInnerHTML': { __html: props.utils.messages.whichExtensionHtml() }
    });
  };
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getPacChooser;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_csjs_inject__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getPacChooser(theState) {
  ...
  return function Notifications(props) {
    ...
    return createVNode(2, 'section', null, [createVNode(2, 'header', null, ['\u042F ', createVNode(2, 'span', 'emoji', '\u2764', {
      'style': 'color: #f93a17'
    }), ' y\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F:']), createVNode(2, 'ul', scopedCss.listOfNotifiers + ' middledChildren', Array.from(props.apis.errorHandlers.getEventsMap()).map(([ntfId, ntfName]) => {

      const iddy = `if-on-${ntfId}`;
      const ifChecked = props.apis.errorHandlers.isOn(ntfId);
      return createVNode(2, 'li', null, [createVNode(512, 'input', null, null, {
        'type': 'checkbox',
        'id': iddy,
        'checked': ifChecked,
        'disabled': props.ifInputsDisabled,
        'onClick': () => {
          ...
          props.apis.errorHandlers.switch(ifChecked ? 'off' : 'on', // Reverse.
          ntfId);
        }
      }), ' ', createVNode(2, 'label', null, ntfName, {
        'for': iddy
      })]);
    }))]);
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_csjs_inject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__LastUpdateDate__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__InfoLi__ = __webpack_require__(12);
...
function getPacChooser(theState) {
  ...
  const LastUpdateDate = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__LastUpdateDate__["a" /* default */])(theState);
  const InfoLi = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__InfoLi__["a" /* default */])(theState);

  return class PacChooser extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    constructor(props) {
      ...
      this.updatePac = function updatePac(onSuccess) {
        props.funs.conduct(chrome.i18n.getMessage('UpdatingDDD'), cb => theState.apis.antiCensorRu.syncWithPacProviderAsync(cb), chrome.i18n.getMessage('UpdatedD'), onSuccess);
      };
    ...
    radioClickHandler(event) {
      ...
      const checkChosenProvider = () => this.setState({ chosenPacName: this.getCurrentProviderId() });

      const pacKey = event.target.id;
      if (pacKey === (theState.apis.antiCensorRu.getCurrentPacProviderKey() || 'none')) {
        return false;
      }
      if (pacKey === 'none') {
        this.props.funs.conduct(chrome.i18n.getMessage('DisablingDDD'), cb => theState.apis.antiCensorRu.clearPacAsync(cb), chrome.i18n.getMessage('DisabledD'), () => this.setState({ chosenPacName: 'none' }), checkChosenProvider);
      } else {
        this.props.funs.conduct(chrome.i18n.getMessage('InstallingDDD'), cb => theState.apis.antiCensorRu.installPacAsync(pacKey, cb), chrome.i18n.getMessage('PacScriptWasInstalledD'), checkChosenProvider);
      }
      return false;
    }
    ...
    render(props) {
      ...
      return createVNode(2, 'div', null, [props.flags.ifInsideOptionsPage && createVNode(2, 'header', null, [chrome.i18n.getMessage('PAC_script'), ':']), createVNode(2, 'ul', null, [...theState.apis.antiCensorRu.getSortedEntriesForProviders(), { key: 'none', label: chrome.i18n.getMessage('Disable') }].map(provConf => createVNode(16, InfoLi, null, null, {
        ...
        'ifInputsDisabled': props.ifInputsDisabled,
        'nodeAfterLabel': createVNode(2, 'a', scopedCss.updateButton, ['[', chrome.i18n.getMessage('update'), ']'], {
          'href': '',
          'onClick': this.updateClickHandler
        })
      }))), createVNode(2, 'div', 'horFlex', [__WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(LastUpdateDate, props), createVNode(2, 'div', scopedCss.fullLineHeight, props.flags.ifMini ? createVNode(2, 'a', scopedCss.otherVersion + ' emoji', '\uD83C\uDFCB', {
        'href': 'https://rebrand.ly/ac-versions',
        'title': chrome.i18n.getMessage("FullVersion")
      }) : createVNode(2, 'a', scopedCss.otherVersion + ' emoji', '\uD83D\uDC0C', {
        'href': 'https://rebrand.ly/ac-versions',
        'title': chrome.i18n.getMessage("VersionForSlowMachines")
      }))], {
        'id': 'updateMessage',
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getProxyEditor;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_component__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getProxyEditor(theState) {
  ...
  const splitBySemi = proxyString => proxyString.replace(/#.*$/mg, '').trim().split(/\s*;\r?\n\s*/g).map(s => s.trim()).filter(s => s);
  ...
  const SwitchButton = props => createVNode(2, 'button', 'emoji' + ' ' + scopedCss.export + ' ' + scopedCss.only, '\u21C4', {
    'type': 'button',
    'disabled': props.ifInputsDisabled,
    'title': props.title,
    'onClick': props.onClick
  ...
  class TabledEditor extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    render(props) {
      ...
      return createVNode(2, 'form', null, [createVNode(2, 'table', scopedCss.editor + ' ' + scopedCss.tabledEditor, [createVNode(2, 'thead', null, createVNode(2, 'tr', null, [createVNode(2, 'th', scopedCss.shrink, '\u043F\u0440\u043E\u0442\u043E\u043A\u043E\u043B', {
        'colspan': '2'
      }), createVNode(2, 'th', null, '\u0434\u043E\u043C\u0435\u043D / IP'), createVNode(2, 'th', scopedCss.shrink, '\u043F\u043E\u0440\u0442'), createVNode(2, 'th', null, createVNode(16, SwitchButton, null, null, {
        'title': '\u0438\u043C\u043F\u043E\u0440\u0442/\u044D\u043A\u0441\u043F\u043E\u0440\u0442',
        'onClick': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleModeSwitch)
      }))])), createVNode(2, 'tbody', null, [createVNode(2, 'tr', scopedCss.addPanel, [createVNode(2, 'td', null, createVNode(2048, 'select', scopedCss.noPad, PROXY_TYPE_LABEL_PAIRS.map(([type, label]) => createVNode(2, 'option', null, label || type, {
        'value': type,
        'selected': type === this.state.selectedNewType
      })), {
        'reqiured': true,
        'name': 'newProxyType',
        'onChange': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleTypeSelect)
      }), {
        'colspan': '2'
      }), createVNode(2, 'td', null, createVNode(512, 'input', scopedCss.noPad, null, {
        'required': true,
        'disabled': props.ifInputsDisabled,
        'placeholder': '89.140.125.17',
        'name': 'newHostname',
        'onInvalid': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.showInvalidMessage),
        'tabindex': '1'
      })), createVNode(2, 'td', null, createVNode(512, 'input', scopedCss.noPad + ' ' + scopedCss.padLeft + ' ' + scopedCss.only, null, {
        'required': true,
        'type': 'number',
        'disabled': props.ifInputsDisabled,
        'placeholder': '9150',
        ...
        'onkeydown': onlyPort,
        'tabindex': '2'
      })), createVNode(2, 'td', null, createVNode(512, 'input', scopedCss.add + ' ' + scopedCss.only, null, {
        'type': 'submit',
        'disabled': props.ifInputsDisabled,
        ...
        return createVNode(2, 'tr', scopedCss.proxyRow, [createVNode(2, 'td', null, createVNode(2, 'button', scopedCss.only, 'X', {
          'type': 'button',
          'disabled': props.ifInputsDisabled,
          'title': '\u0423\u0434\u0430\u043B\u0438\u0442\u044C',
          'onClick': () => this.handleDelete(this, { proxyAsString, index })
        })), createVNode(2, 'td', null, type), createVNode(2, 'td', null, createVNode(512, 'input', null, null, {
          'value': `${creds && `${creds}@`}${hostname}`,
          'name': 'crededHostname',
          'readonly': true
        })), createVNode(2, 'td', null, port), createVNode(2, 'td', null, createVNode(2, 'button', scopedCss.only, '\u25B2', {
          'type': 'button',
          'disabled': props.ifInputsDisabled,
          'title': '\u041F\u043E\u0432\u044B\u0441\u0438\u0442\u044C \u043F\u0440\u0438\u043E\u0440\u0438\u0442\u0435\u0442',
          'onClick': () => this.raisePriority(this, { proxyAsString, index })
        }))]);
      })])]), createVNode(2, 'a', null, '\u0417\u0430\u043F\u0430\u0440\u043E\u043B\u0435\u043D\u043D\u044B\u0435 \u043F\u0440\u043E\u043A\u0441\u0438?', {
        'href': 'https://rebrand.ly/ac-protected-proxy'
      })], {
        'onSubmit': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleSubmit)
      });
    }
  }
  ...
  class ExportsEditor extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {

    constructor(props) {

      super(props);
      this.state = getInitState();
      this.resetState = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.resetState);
      this.showApply = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(undefined, props.setProxyStringRaw);
    }
    ...
    getErrorsInStashedExports() {
      ...
      const errors = splitBySemi(this.state.stashedExports).map(proxyAsString => {
        ...
        if (!knownTypes.includes(type.toUpperCase())) {
          return new Error(`Неверный тип ${type}. Известные типы: ${knownTypes.join(', ')}.`);
        }
        if (!(crededAddr && /^(?:.+@)?[^:]+:\d+$/.test(crededAddr))) {
          return new Error(`Адрес прокси "${crededAddr || ''}" не соответствует формату "<опц_логин>:<опц_пароль>@<домен_или_IP>:<порт_из_цифр>".`);
        }
        ...
        if (portInt < 0 || portInt > 65535) {
          return new Error(`Порт "${port}" должен быть целым числом от 0 до 65535.`);
        }
        return false;
      }).filter(e => e);
    ...
    render(props) {
      ...
      return createVNode(2, 'form', null, createVNode(2, 'table', scopedCss.editor + ' ' + scopedCss.exportsEditor, [createVNode(2, 'thead', null, createVNode(2, 'tr', null, [createVNode(2, 'th', null, this.state.stashedExports === false ? 'Комментарии вырезаются!' : this.state.ifHasErrors ? createVNode(2, 'span', null, [createVNode(2, 'a', null, '\u0421\u0431\u0440\u043E\u0441\u044C\u0442\u0435 \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F', {
        'href': '',
        'onClick': this.resetState,
        'style': 'color: red'
      }), ' \u0438\u043B\u0438 \u043F\u043E\u043F\u0440\u0430\u0432\u044C\u0442\u0435']) : createVNode(2, 'a', null, '\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F', {
        'href': '',
        'onClick': this.resetState
      }), {
        'style': 'width: 100%'
      }), createVNode(2, 'th', null, createVNode(16, SwitchButton, null, null, {
        'title': '\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0438\u0442\u044C\u0441\u044F \u0432 \u0442\u0430\u0431\u043B\u0438\u0447\u043D\u044B\u0439 \u0440\u0435\u0436\u0438\u043C',
        'onClick': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleModeSwitch)
      }), {
        'style': 'width: 1%'
      })])), createVNode(2, 'tbody', null, createVNode(2, 'tr', null, createVNode(2, 'td', null, createVNode(1024, 'textarea', scopedCss.textarea, null, {
        'spellcheck': false,
        'placeholder': `
...
PROXY foobar.com:8080; # Not HTTP!`.trim(),
        'onChange': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleTextareaChange),
        'onFocus': this.showApply,
        'value': this.state.stashedExports !== false ? this.state.stashedExports : (this.props.proxyStringRaw || '').replace(/\s*;\n\s*/g, ';\n')
      }), {
        'colspan': '2'
      })))]), {
        'onSubmit': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])(this, this.handleSubmit)
  ...
  const migrate = proxyStringRaw => {
    ...
    return proxyStringRaw.replace(/#.*$/mg, '') // Strip comments.
  ...
  return class ProxyEditor extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    render(originalProps) {
      ...
      return this.state.ifExportsMode ? __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(ExportsEditor, props) : __WEBPACK_IMPORTED_MODULE_2_inferno_create_element___default()(TabledEditor, props);
    }
  };
};
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getTabPannel;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_component__);
...
var createVNode = __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.createVNode;
function getTabPannel({ flags, baseCss }) {
  ...
  return class TabPannel extends __WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a {
    ...
    render(props) {
      ...
      let [chosenTabIndex] = indexedTabs.map((tab, index) => tab.key === this.state.chosenTabKeyRaw ? index : false).filter(index => index !== false);
      if (!(chosenTabIndex >= 0)) {
        chosenTabIndex = 0;
      }
      ...
      return createVNode(2, 'div', null, [createVNode(2, 'nav', scopedCss.navLabels, [createVNode(2, 'ul', 'horizontalList', indexedTabs.map((tab, index) => createVNode(2, 'li', null, [createVNode(512, 'input', 'off', null, {
        'type': 'radio',
        'name': 'selectedTabLabel',
        'id': 'radioLabel' + index,
        'checked': chosenTabIndex === index
      }), createVNode(2, 'label', scopedCss.navLabel, tab.label, {
        'onClick': () => this.setState({ chosenTabKeyRaw: tab.key }),
        'for': 'radioLabel' + index
      })]))), createVNode(2, 'hr')]), createVNode(2, 'nav', 'horPadded ' + scopedCss.mainNav, [].concat(...props.tabs.map((tab, index) => [createVNode(512, 'input', 'off', null, {
        'type': 'checkbox',
        'name': 'selectedTab',
        'id': 'radioTab' + index,
        'checked': chosenTabKey === tab.key || (props.alwaysShownWith[tab.key] || []).includes(chosenTabKey)
      }), createVNode(2, 'section', scopedCss.tabContainer, tab.content, {
        'id': 'tab' + index,
        'data-key': tab.key
      })]))), createVNode(2, 'hr')]);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_create_element__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_create_element___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno_create_element__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__globalCss__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csjs_inject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_csjs_inject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_csjs_inject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_App__ = __webpack_require__(21);
...
chrome.runtime.getBackgroundPage(bgWindow => bgWindow.apis.errorHandlers.installListenersOn(window, 'PUP', async () => {
  /*
  ...
  */
  ...
  const currentTab = await new Promise(resolve => winChrome.tabs.query({ active: true, currentWindow: true }, ([tab]) => resolve(tab)));
  ...
  theState.flags.ifOpenedUnsafely = Boolean((await new Promise(resolve => winChrome.tabs.getCurrent(resolve))));

  // STATE DEFINED, COMPOSE.

  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__globalCss__["a" /* default */])(document, theState);
  // Extendable css classes.

  __WEBPACK_IMPORTED_MODULE_0_inferno___default.a.render(__WEBPACK_IMPORTED_MODULE_1_inferno_create_element___default()(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__components_App__["a" /* default */])(theState), theState), document.getElementById('app-root'));
  // READY TO RENDER
...
var csjs = __webpack_require__(39);
var insertCss = __webpack_require__(64);
...
var csjs = __webpack_require__(38);

module.exports = csjs();
module.exports.csjs = csjs;
module.exports.noScope = csjs({ noscope: true });
module.exports.getCss = __webpack_require__(17);
...
var makeComposition = __webpack_require__(13).makeComposition;
...
var extractExtends = __webpack_require__(43);
var composition = __webpack_require__(13);
var isComposition = composition.isComposition;
var ignoreComposition = composition.ignoreComposition;
var buildExports = __webpack_require__(41);
var scopify = __webpack_require__(49);
var cssKey = __webpack_require__(18);
var extractExports = __webpack_require__(44);
...
var regex = __webpack_require__(14);
...
var ignoreComments = __webpack_require__(14).ignoreComments;
...
var fileScoper = __webpack_require__(48);
var replaceAnimations = __webpack_require__(47);
var regex = __webpack_require__(14);
var classRegex = regex.classRegex;
var keyframesRegex = regex.keyframesRegex;
...
var inferno = __webpack_require__(52);
...
var inferno = __webpack_require__(55);
